...
This is the web UI for [`BoteWrite`](https://github.com/Mrguanglei/Botewrite).

## Quick Start

### Prerequisites

- [`BoteWrite`](https://github.com/Mrguanglei/Botewrite)
- Node.js (v22.14.0+)
...
BoteWrite Web UI uses `pnpm` as its package manager.
...
BoteWrite is built upon the foundation of these outstanding projects:
...
These outstanding projects form the backbone of BoteWrite and exemplify the transformative power of open source collaboration.
