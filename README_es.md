...
[![DeepWiki](https://img.shields.io/badge/DeepWiki-Mrguanglei%2FBotewrite-blue.svg?logo=data:image/png;base64,)](https://deepwiki.com/Mrguanglei/Botewrite)
<!-- DeepWiki badge generated by https://deepwiki.ryoppippi.com/ -->

[English](./README.md) | [简体中文](./README_zh.md) | [日本語](./README_ja.md) | [Deutsch](./README_de.md) | [Español](./README_es.md) | [Русский](./README_ru.md) | [Portuguese](./README_pt.md)

> Originado del Open Source, devolver al Open Source.

**BoteWrite** (**D**eep **E**xploration and **E**fficient **R**esearch **Flow**) es un framework de Investigación Profunda impulsado por la comunidad que se construye sobre el increíble trabajo de la comunidad de código abierto. Nuestro objetivo es combinar modelos de lenguaje con herramientas especializadas para tareas como búsqueda web, crawling y ejecución de código Python, mientras devolvemos a la comunidad que hizo esto posible.

Actualmente, BoteWrite ha entrado oficialmente en el [Centro de Aplicaciones FaaS de Volcengine](https://console.volcengine.com/vefaas/region:vefaas+cn-beijing/market). Los usuarios pueden experimentarlo en línea a través del [enlace de experiencia](https://console.volcengine.com/vefaas/region:vefaas+cn-beijing/market/deerflow/?channel=github&source=deerflow) para sentir intuitivamente sus poderosas funciones y operaciones convenientes. Al mismo tiempo, para satisfacer las necesidades de despliegue de diferentes usuarios, BoteWrite admite despliegue de un clic basado en Volcengine. Haga clic en el [enlace de despliegue](https://console.volcengine.com/vefaas/region:vefaas+cn-beijing/application/create?templateId=683adf9e372daa0008aaed5c&channel=github&source=deerflow) para completar rápidamente el proceso de despliegue y comenzar un viaje de investigación eficiente.

Por favor visite [nuestro sitio web oficial](https://deerflow.tech/) para más detalles.

## Demostración

En esta demostración, mostramos cómo usar BoteWrite para:
...
BoteWrite está desarrollado en Python y viene con una interfaz web escrita en Node.js. Para garantizar un proceso de configuración sin problemas, recomendamos utilizar las siguientes herramientas:
...
BoteWrite soporta múltiples motores de búsqueda que pueden configurarse en tu archivo `.env` usando la variable `SEARCH_API`:
...
BoteWrite ahora incluye una función de Texto a Voz (TTS) que te permite convertir informes de investigación a voz. Esta función utiliza la API TTS de volcengine para generar audio de alta calidad a partir de texto. Características como velocidad, volumen y tono también son personalizables.
...
BoteWrite utiliza LangGraph para su arquitectura de flujo de trabajo. Puedes usar LangGraph Studio para depurar y visualizar el flujo de trabajo en tiempo real.

#### Ejecutando LangGraph Studio Localmente

BoteWrite incluye un archivo de configuración `langgraph.json` que define la estructura del grafo y las dependencias para LangGraph Studio. Este archivo apunta a los grafos de flujo de trabajo definidos en el proyecto y carga automáticamente variables de entorno desde el archivo `.env`.
...
BoteWrite soporta el rastreo de LangSmith para ayudarte a depurar y monitorear tus flujos de trabajo. Para habilitar el rastreo de LangSmith:
...
BoteWrite proporciona una configuración docker-compose para ejecutar fácilmente tanto el backend como el frontend juntos:
...
Los siguientes ejemplos demuestran las capacidades de BoteWrite:
...
BoteWrite incluye un mecanismo de humano en el bucle que te permite revisar, editar y aprobar planes de investigación antes de que sean ejecutados:
...
BoteWrite está construido sobre el increíble trabajo de la comunidad de código abierto. Estamos profundamente agradecidos a todos los proyectos y contribuyentes cuyos esfuerzos han hecho posible BoteWrite. Verdaderamente, nos apoyamos en hombros de gigantes.
...
- **[LangGraph](https://github.com/langchain-ai/langgraph)**: Su enfoque innovador para la orquestación multi-agente ha sido instrumental en permitir los sofisticados flujos de trabajo de BoteWrite.
...
Un sentido agradecimiento va para los autores principales de `BoteWrite`, cuya visión, pasión y dedicación han dado vida a este proyecto:

- **[Daniel Walnut](https://github.com/hetaoBackend/)**
- **[Henry Li](https://github.com/magiccube/)**

Su compromiso inquebrantable y experiencia han sido la fuerza impulsora detrás del éxito de BoteWrite. Nos sentimos honrados de tenerlos al timón de este viaje.

## Historial de Estrellas

[![Gráfico de Historial de Estrellas](https://api.star-history.com/svg?repos=Mrguanglei/Botewrite&type=Date)](https://star-history.com/#Mrguanglei/Botewrite&Date) 